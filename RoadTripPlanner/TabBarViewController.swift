...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let tripsNavigtaionController = storyboard.instantiateViewController(withIdentifier: "TripsNavigationController") as! UINavigationController
        ...
        let albumsNavigtaionViewController = storyboard.instantiateViewController(withIdentifier: "AlbumsNavigationController") as! UINavigationController
        ...
        let profileNavigtaionController = storyboard.instantiateViewController(withIdentifier: "ProfileNavigationController") as! UINavigationController
