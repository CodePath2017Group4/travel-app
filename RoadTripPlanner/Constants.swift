...
struct Constants {
    ...
    struct Colors {
        ...
        static let NavigationBarDarkTintColor = #colorLiteral(red: 0.3155559897, green: 0.558322072, blue: 0.7498114705, alpha: 1)
        ...
        static let ColorPalette3314Color3 = #colorLiteral(red: 0.7996619344, green: 0.8581457138, blue: 0.9196920991, alpha: 1)
        static let ColorPalette3314Color4 = #colorLiteral(red: 0.9685407281, green: 0.9647654891, blue: 0.9645374417, alpha: 1)
        static let ColorPalette3314Color5 = #colorLiteral(red: 0.8603140116, green: 0.5897349119, blue: 0.6455273032, alpha: 1)
        
        static let ColorPalette3495Color1 = #colorLiteral(red: 0.4235294118, green: 0.4823529412, blue: 0.1647058824, alpha: 1)
